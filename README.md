...
bash
git clone https://github.com/dinukadk/ITPM-Assignment-01.git
...
bash
python IT23146174_test_automation.py --excel "IT23146174_Assignment 1 - Test cases.xlsx" --url "https://www.pixelssuite.com/chat-translator" --wait-ms 5000 --type-delay-ms 80 --slow-mo-ms 200 --save-every 1 --keep-open
